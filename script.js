...
let appData = {
    ...
    getTargetMonth: function() {
        return Math.ceil(appData.mission / this.getAccumulatedMonth());
    },
...
let accumulatedMonth = appData.getAccumulatedMonth(); // == money - (amount1 + amount2) == бюджет это накопленная сумма за месяц 
